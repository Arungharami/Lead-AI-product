...
export const Landing = () => <div className='space-y-10'>
...
<div className='mt-6 flex gap-4'><Link to='/pricing' className='rounded-xl bg-blue-500 px-5 py-3 font-semibold'>Start Free</Link><Link to='/marketplace' className='rounded-xl border border-slate-600 px-5 py-3'>Explore AI Tools</Link></div>
...
<section><h2 className='mb-4 text-2xl font-semibold'>Core Product Categories</h2><div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>{categories.map(c=><div key={c} className='glass rounded-2xl p-4'>{c}</div>)}</div></section>
</div>;
